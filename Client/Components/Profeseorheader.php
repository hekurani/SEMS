<nav
    class="w-full fixed top-0 z-10 flex items-center justify-between bg-gray-200 py-2 shadow-dark-mild dark:bg-body-dark lg:flex-wrap lg:justify-start lg:py-4"
    data-twe-navbar-ref>
        ...
        <ul
          ...
          <li class="mb-4 lg:mb-0 lg:pe-2" data-twe-nav-item-ref>
            <form action="utils/logOut.php" method="post">
              <button type="submit" class="block text-black/60 transition duration-200 hover:text-black/80 hover:bg-gray-300 focus:text-black/80 active:text-black/80 motion-reduce:transition-none dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 dark:active:text-white/80 lg:px-2">
                Log Out
              </button>
            </form>
          </li>
